    ...
    public class ThemeableViewLocationExpander : IViewLocationExpander
    {
        ...
        public void PopulateValues(ViewLocationExpanderContext context)
        {
            ...
            else
            {
                ...
                context.Values[THEME_KEY] = "Generic";
            }
        }
    }
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            if (context.Values.ContainsKey(_moduleKey))
            {
                ...
                if (!string.IsNullOrWhiteSpace(module))
                {
                    var moduleViewLocations = new string[]
                    {
                       "/HCF.Module." + module + "/Areas/Views/{1}/{0}.cshtml",
                       "/HCF.Module." + module + "/Areas/Views/Shared/{0}.cshtml",
                       "/HCF.Module." + module + "/Areas/Views/Shared/Components/{1}/{0}.cshtml",
