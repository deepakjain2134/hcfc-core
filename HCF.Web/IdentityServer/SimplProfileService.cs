...
namespace HCF.Web.IdentityServer
{
    ...
    {
        private readonly ILogger<ProfileService<UserProfile>> _logger;
        private readonly UserManager<UserProfile> _userManager;

        public SimplProfileService(UserManager<UserProfile> userManager,
            ILogger<ProfileService<UserProfile>> logger)
        {
            _logger = logger;
