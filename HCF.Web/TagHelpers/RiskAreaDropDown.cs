...
namespace HCF.Web.TagHelpers
{
    ...
    [HtmlTargetElement("riskareadropdown")]
    public class RiskAreaDropDown : TagHelper
    {
        private readonly IHtmlHelper _html;
        private readonly IConstructionService _constructionService;

        public RiskAreaDropDown(IHtmlHelper helper, IConstructionService constructionService)
        {
            _html = helper;
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var projecttype = _constructionService.GetICRARiskAra().Where(x => x.IsActive).ToList();
