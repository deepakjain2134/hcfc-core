...
namespace HCF.Web.TagHelpers
{
    /// <summary>    
    /// </summary>
    [HtmlTargetElement("vendordropdownlist")]
    public class VendorDropDownList : TagHelper
    {
        private readonly IHtmlHelper _html;
        private readonly IVendorService _service;

        public VendorDropDownList(IHtmlHelper helper, IVendorService service)
        {
            _html = helper;
            _service = service;
        }
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var activeVendor = _service.GetVendorDetails().Where(x => x.IsActive).ToList();
