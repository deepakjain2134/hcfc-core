...
{
    [HtmlTargetElement("routeurldropdown")]
    public class RouteUrlDropdown : TagHelper
    {
        private readonly IHtmlHelper _html;
        private readonly IAppSetting _appSetting ;

        public RouteUrlDropdown(IHtmlHelper helper, IAppSetting appSetting)
        {
            _html = helper;
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var tipRouteUrl = _appSetting.TipRouteUrls.Split(',').ToList();
            var searchFieldList = new List<SelectedList> { new SelectedList() {
                Text = "Select route URL", Value = "" } };
