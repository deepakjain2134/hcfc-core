...
{
    [HtmlTargetElement("activestatusdropdown")]
    public class ActiveStatusDropDown:TagHelper
    {
        private readonly IHtmlHelper _html;
      

        public ActiveStatusDropDown(IHtmlHelper helper)
        {
            _html = helper;
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var searchFieldList = new
               List<SelectedList> {
                                         ...
                                         new SelectedList {Text = "ACTIVE", Value = "ACTIVE"},
                                         new SelectedList {Text = "INACTIV", Value = "INACTIVE"}
