...
namespace HCF.Web.TagHelpers
{
    ...
    /// 
    /// </summary>
    [HtmlTargetElement("tiptypesdropdownlist")]
    public class TipTypesDropDownList : TagHelper
    {
        private readonly IHtmlHelper _html;      

        public TipTypesDropDownList(IHtmlHelper helper)
        {
            _html = helper;
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var lists = from BDO.Enums.TipTypes e in Enum.GetValues(typeof(BDO.Enums.TipTypes))
                        select new
                        {
                            Value = (int)e,
