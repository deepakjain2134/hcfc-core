...
{
    [HtmlTargetElement("frequencydropdownlist")]
    public class FrequencyDropDownList : TagHelper
    {
        private readonly IHtmlHelper _html;
        
        public FrequencyDropDownList(IHtmlHelper helper)
        {
            _html = helper;
        ...
        [HtmlAttributeName("frequencyids")]
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var lists = from BDO.Enums.Frequency e in Enum.GetValues(typeof(BDO.Enums.Frequency))
                        select new
                        {
                            Value = (int)e,
