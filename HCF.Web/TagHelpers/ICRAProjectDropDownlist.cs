...
{
    [HtmlTargetElement("icraprojectdropdownlist")]
    public class ICRAProjectDropDownlist : TagHelper
    {
        private readonly IHtmlHelper _html;
        private readonly ITIcraProjectService _constructionService;

        public ICRAProjectDropDownlist(IHtmlHelper helper, ITIcraProjectService constructionService)
        {
            _html = helper;
        ...
        private  List<SelectListItem> BindItems()
        {
            ...
            var icraProjectList =_constructionService.GetAllActiveTIcraProject();
