...
{
    [HtmlTargetElement("sitetypedropdownlist")]
    public class SiteTypeDropDownList : TagHelper
    {
        private readonly IHtmlHelper _html;
        private readonly ISiteService _siteService;

        public SiteTypeDropDownList(IHtmlHelper helper, ISiteService siteService)
        {
            _html = helper;
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var siteTypes = _siteService.GetSiteType().Where(x => x.IsActive).ToList();
