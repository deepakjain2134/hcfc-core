...
namespace HCF.Web.TagHelpers
{
    ...
    [HtmlTargetElement("firerisktypedropdownlist")]
    public class FireRiskTypeDropDownList : TagHelper
    {
        private readonly IHtmlHelper _html;
        
        public FireRiskTypeDropDownList(IHtmlHelper helper)
        {
            _html = helper;          
        }
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var lists = from BDO.Enums.FireRiskType e in Enum.GetValues(typeof(BDO.Enums.FireRiskType))
                        select new
                        {
                            Value = (int)e,
