...
{
    [HtmlTargetElement("icralistdropdownlist")]
    public class ICRAListDropDownList : TagHelper
    {
        private readonly IHtmlHelper _html;
        private readonly IConstructionService _constructionService;

        public ICRAListDropDownList(IHtmlHelper helper, IConstructionService constructionService)
        {
            _html = helper;
        ...
        private List<SelectListItem> BindItems()
        {
            ...
            var lists = _constructionService.GetIcras().Where(x => x.IsActive).ToList();
