    ...
    $.extend(Plugin.prototype, {
        ...
        _change: function (e) {
            ...
            switch (this.settings.state) {
                case true: this.settings.state = (this.settings.reverse ? false : null); this.element.attr("staus","fail"); break;
                case false: this.settings.state = (this.settings.reverse ? null : true); this.element.attr("staus", "pass"); break;
                default: this.settings.state = (this.settings.reverse ? true : false); this.element.attr("staus", "none"); break;
            }
