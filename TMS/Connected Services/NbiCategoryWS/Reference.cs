...
namespace NbiCategoryWS
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.frsoft.com/webservices", ConfigurationName="NbiCategoryWS.CategoryWSSoap")]
    public interface CategoryWSSoap
    {
        ...
        System.Threading.Tasks.Task<NbiCategoryWS.Category> LoadAsync(NbiCategoryWS.AuthenticationHeader header, string moduleCode, string code, int segmentID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.frsoft.com/webservices/Save", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SDKBase))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(CustomField[]))]
        System.Threading.Tasks.Task<NbiCategoryWS.Category> SaveAsync(NbiCategoryWS.AuthenticationHeader header, NbiCategoryWS.Category sdkCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.frsoft.com/webservices/GetCodes", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SDKBase))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(CustomField[]))]
        System.Threading.Tasks.Task<NbiCategoryWS.Category[]> GetCodesAsync(NbiCategoryWS.AuthenticationHeader header, string moduleCode, int segmentID, bool includeShared);
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www.frsoft.com/webservices")]
    public partial class Category : CodeBase
    {
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface CategoryWSSoapChannel : NbiCategoryWS.CategoryWSSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class CategoryWSSoapClient : System.ServiceModel.ClientBase<NbiCategoryWS.CategoryWSSoap>, NbiCategoryWS.CategoryWSSoap
    {
        ...
        public CategoryWSSoapClient(EndpointConfiguration endpointConfiguration) : 
                base(CategoryWSSoapClient.GetBindingForEndpoint(endpointConfiguration), CategoryWSSoapClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public CategoryWSSoapClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(CategoryWSSoapClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public CategoryWSSoapClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(CategoryWSSoapClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public CategoryWSSoapClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress)
        {
        }
        
        public System.Threading.Tasks.Task<NbiCategoryWS.Category> LoadAsync(NbiCategoryWS.AuthenticationHeader header, string moduleCode, string code, int segmentID)
        {
            return base.Channel.LoadAsync(header, moduleCode, code, segmentID);
        }
        
        public System.Threading.Tasks.Task<NbiCategoryWS.Category> SaveAsync(NbiCategoryWS.AuthenticationHeader header, NbiCategoryWS.Category sdkCode)
        {
            return base.Channel.SaveAsync(header, sdkCode);
        }
        
        public System.Threading.Tasks.Task<NbiCategoryWS.Category[]> GetCodesAsync(NbiCategoryWS.AuthenticationHeader header, string moduleCode, int segmentID, bool includeShared)
        {
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.CategoryWSSoap))
            {
            ...
            if ((endpointConfiguration == EndpointConfiguration.CategoryWSSoap12))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.CategoryWSSoap))
            {
                return new System.ServiceModel.EndpointAddress("https://rwjbh.tmsonline.com/tmsconnect/Codes/CategoryWS.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.CategoryWSSoap12))
            {
                return new System.ServiceModel.EndpointAddress("https://rwjbh.tmsonline.com/tmsconnect/Codes/CategoryWS.asmx");
