...
namespace NbiTypeWS
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.frsoft.com/webservices", ConfigurationName="NbiTypeWS.TypeWSSoap")]
    public interface TypeWSSoap
    {
        ...
        System.Threading.Tasks.Task<NbiTypeWS.Type> LoadAsync(NbiTypeWS.AuthenticationHeader header, string moduleCode, string code, int segmentID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.frsoft.com/webservices/Save", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SDKBase))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(CustomField[]))]
        System.Threading.Tasks.Task<NbiTypeWS.Type> SaveAsync(NbiTypeWS.AuthenticationHeader header, NbiTypeWS.Type sdkCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.frsoft.com/webservices/GetCodes", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SDKBase))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(CustomField[]))]
        System.Threading.Tasks.Task<NbiTypeWS.Type[]> GetCodesAsync(NbiTypeWS.AuthenticationHeader header, string moduleCode, int segmentID, bool includeShared);
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www.frsoft.com/webservices")]
    public partial class Type : CodeBase
    {
        
        private int escalateField;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface TypeWSSoapChannel : NbiTypeWS.TypeWSSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class TypeWSSoapClient : System.ServiceModel.ClientBase<NbiTypeWS.TypeWSSoap>, NbiTypeWS.TypeWSSoap
    {
        ...
        public TypeWSSoapClient(EndpointConfiguration endpointConfiguration) : 
                base(TypeWSSoapClient.GetBindingForEndpoint(endpointConfiguration), TypeWSSoapClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public TypeWSSoapClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(TypeWSSoapClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public TypeWSSoapClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(TypeWSSoapClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public TypeWSSoapClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress)
        {
        }
        
        public System.Threading.Tasks.Task<NbiTypeWS.Type> LoadAsync(NbiTypeWS.AuthenticationHeader header, string moduleCode, string code, int segmentID)
        {
            return base.Channel.LoadAsync(header, moduleCode, code, segmentID);
        }
        
        public System.Threading.Tasks.Task<NbiTypeWS.Type> SaveAsync(NbiTypeWS.AuthenticationHeader header, NbiTypeWS.Type sdkCode)
        {
            return base.Channel.SaveAsync(header, sdkCode);
        }
        
        public System.Threading.Tasks.Task<NbiTypeWS.Type[]> GetCodesAsync(NbiTypeWS.AuthenticationHeader header, string moduleCode, int segmentID, bool includeShared)
        {
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.TypeWSSoap))
            {
            ...
            if ((endpointConfiguration == EndpointConfiguration.TypeWSSoap12))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.TypeWSSoap))
            {
                return new System.ServiceModel.EndpointAddress("https://rwjbh.tmsonline.com/tmsconnect/Codes/TypeWS.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.TypeWSSoap12))
            {
                return new System.ServiceModel.EndpointAddress("https://rwjbh.tmsonline.com/tmsconnect/Codes/TypeWS.asmx");
