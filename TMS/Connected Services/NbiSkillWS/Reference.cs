...
namespace NbiSkillWS
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.frsoft.com/webservices", ConfigurationName="NbiSkillWS.SkillWSSoap")]
    public interface SkillWSSoap
    {
        ...
        System.Threading.Tasks.Task<NbiSkillWS.Skill> LoadAsync(NbiSkillWS.AuthenticationHeader header, string code, int segmentID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.frsoft.com/webservices/Save", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SDKBase))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(CustomField[]))]
        System.Threading.Tasks.Task<NbiSkillWS.Skill> SaveAsync(NbiSkillWS.AuthenticationHeader header, NbiSkillWS.Skill sdkCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.frsoft.com/webservices/GetCodes", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SDKBase))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(CustomField[]))]
        System.Threading.Tasks.Task<NbiSkillWS.Skill[]> GetCodesAsync(NbiSkillWS.AuthenticationHeader header, int segmentID, bool includeShared);
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www.frsoft.com/webservices")]
    public partial class Skill : CodeBase
    {
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface SkillWSSoapChannel : NbiSkillWS.SkillWSSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class SkillWSSoapClient : System.ServiceModel.ClientBase<NbiSkillWS.SkillWSSoap>, NbiSkillWS.SkillWSSoap
    {
        ...
        public SkillWSSoapClient(EndpointConfiguration endpointConfiguration) : 
                base(SkillWSSoapClient.GetBindingForEndpoint(endpointConfiguration), SkillWSSoapClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SkillWSSoapClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(SkillWSSoapClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SkillWSSoapClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(SkillWSSoapClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public SkillWSSoapClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress)
        {
        }
        
        public System.Threading.Tasks.Task<NbiSkillWS.Skill> LoadAsync(NbiSkillWS.AuthenticationHeader header, string code, int segmentID)
        {
            return base.Channel.LoadAsync(header, code, segmentID);
        }
        
        public System.Threading.Tasks.Task<NbiSkillWS.Skill> SaveAsync(NbiSkillWS.AuthenticationHeader header, NbiSkillWS.Skill sdkCode)
        {
            return base.Channel.SaveAsync(header, sdkCode);
        }
        
        public System.Threading.Tasks.Task<NbiSkillWS.Skill[]> GetCodesAsync(NbiSkillWS.AuthenticationHeader header, int segmentID, bool includeShared)
        {
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.SkillWSSoap))
            {
            ...
            if ((endpointConfiguration == EndpointConfiguration.SkillWSSoap12))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.SkillWSSoap))
            {
                return new System.ServiceModel.EndpointAddress("https://rwjbh.tmsonline.com/tmsconnect/Codes/SkillWS.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.SkillWSSoap12))
            {
                return new System.ServiceModel.EndpointAddress("https://rwjbh.tmsonline.com/tmsconnect/Codes/SkillWS.asmx");
