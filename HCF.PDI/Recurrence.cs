...
// distributed with the code and can be found at the project website: https://github.com/HCF/PDI.
...
namespace HCF.PDI
{
    ...
    public class Recurrence : ISerializable, IXmlSerializable
    {
        ...
        /// starting date/time as an extended property (X-HCF-DTSTART) which isn't normally part of the
        ...
        {
            return String.Format(CultureInfo.InvariantCulture, "{0};X-HCF-DTSTART={1}", this.ToString(),
        ...
        public XmlSchema GetSchema()
        {
            ...
            using(StreamReader sr = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream(
              "HCF.PDI.Schemas.Recurrence.xsd")))
            {
