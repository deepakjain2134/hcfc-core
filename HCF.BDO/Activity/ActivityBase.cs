namespace HCF.BDO
{
    ...
    /// because NHibernate does not support inheritance. It will not recognize the derived classes as
    ...
    public abstract class ActivityBase
    {
        ...
        public static Dictionary<string, string> UnpackData(Activity activity)
        {
            ...
            {
                var key = keyValuePairRaw.Split('=')[0];
                var data = keyValuePairRaw.Split('=')[1];
