...
//        /// <returns></returns>
//        private static LoggerEntry LogLineFormatter(string line)
//        {
//            try
//            {
...
//                    DbName = lineSplit[1].Trim(),
//                    Module = lineSplit[2].Trim(),
//                    Method = lineSplit[3].Trim(),
//                    DeclaringType = lineSplit[4].Trim(),
//                    LineNumber = lineSplit[5].Trim(),
//                    ErrorMessage = lineSplit[6].Trim(),
//                };
//            }
//            catch (Exception ex)
//            {
...
//        /// </summary>
//        /// <returns></returns>
//        private static List<LoggerEntry> ReadLogFile()
//        {
//            // create empty log list
//            var logs = new List<LoggerEntry>();
...
//        /// </summary>
//        /// <returns></returns>
//        public IList<LoggerEntry> ListLogFile()
//        {
//            return ReadLogFile();
//        }
//    }
