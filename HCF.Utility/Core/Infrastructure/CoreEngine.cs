...
using HCF.Utility.Core.Infrastructure.DependencyManagement;
...
namespace HCF.Utility.Core.Infrastructure
{
    ...
    public class CoreEngine : IEngine
    {
        ...
        public virtual void RegisterDependencies(IServiceCollection services, CoreAppSettings appSettings)
        {
