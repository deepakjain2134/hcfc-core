...
namespace HCF.Module.LuceneSearch.Data
{
        ...
        public static List<SampleData> GetAll()
        {
            return new
              List<SampleData> {
                           ...
                           new SampleData {Id = "3", Name = "Moscow", Description = "City in Russia"},
                           new SampleData {Id = "2", Name = "Chicago", Description = "City in USA"},
