...
{
    public class HcfDatabaseContext : IdentityDbContext<UserProfile, Role, long, IdentityUserClaim<long>, UserRole, IdentityUserLogin<long>, IdentityRoleClaim<long>, IdentityUserToken<long>>
    {
        public HcfDatabaseContext(DbContextOptions options) : base(options)
        {
        ...
        private static void RegisterConvention(ModelBuilder modelBuilder)
        {
            foreach (var entity in modelBuilder.Model.GetEntityTypes())
            {
                if (entity.ClrType.Namespace != null)
                {
                    ...
                    var tableName = string.Concat(entity.ClrType.Name);
