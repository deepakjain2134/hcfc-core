...
//var ServerLocation = "C:\\cadviewer-testapp-dotnet-01-core\\cadviewer\\\\cadviewer\\\\wwwroot\\";
var ServerLocation = "C:\\InficareProjects\\hcf_core\\Modules\\\\HCF.Module.CadViewer\\\\wwwroot\\"; 	            // .NET  Windows      					// .NET Windows
var ServerUrl = "https://localhost:44325/_content/HCF.Module.CadViewer";


var webUrl = window.location.origin;

if (webUrl.toLowerCase().indexOf('test.crxweb.com') > -1) {
	ServerLocation = "C:\\HCF\\test.crxweb.com\\wwwroot\\_content\\HCF.Module.CadViewer\\";
	ServerUrl = "https://test.crxweb.com/_content/HCF.Module.CadViewer";
}

else if (webUrl.toLowerCase().indexOf('www.core.crxweb.com') > -1) {
	ServerLocation = "C:\\HCF\\prodcuction_core\\Web\wwwroot\\_content\\HCF.Module.CadViewer\\";
	ServerUrl = "https://www.core.crxweb.com/_content/HCF.Module.CadViewer";

}
else if (webUrl.toLowerCase().indexOf('core.crxweb.com') > -1) {
...
else if (webUrl.toLowerCase().indexOf('www.crxweb.com') > -1) {
	ServerLocation = "C:\\HCF\\crxweb.com\\wwwroot\\_content\\HCF.Module.CadViewer\\";
	ServerUrl = "https://www.crxweb.com/_content/HCF.Module.CadViewer";

}
else if (webUrl.toLowerCase().indexOf('crxweb.com') > -1) {
	ServerLocation = "C:\\HCF\\crxweb.com\\wwwroot\\_content\\HCF.Module.CadViewer\\";
	ServerUrl = "https://www.crxweb.com/_content/HCF.Module.CadViewer";
	...
	ServerLocation = "C:\\InficareProjects\\hcf_core\\Modules\\HCF.Module.CadViewer\\wwwroot\\";
	ServerUrl = "https://localhost:44325/_content/HCF.Module.CadViewer";        
}

//var ServerBackEndUrl = ServerUrl;
///*var ServerLocation ="D:\\Inficare_Projects\\HCF\\HCF_Code\\V1_Core\\Modules\\HCF.Module.CadViewer\\wwwroot\\";*/
//var ServerLocation = "C:\\InficareProjects\\hcf_core\\Modules\\HCF.Module.CadViewer\\wwwroot\\";
//console.log(ServerLocation);

//// .NET  Windows
//// Location of installation Url
//var ServerUrl = "https://localhost:44325/_content/HCF.Module.CadViewer/";        					// .NET Windows
